...
public class MediaMovelSimplesTest {
	...
	@Test
	public void sequenciaSimplesDeCandlesFechamento() throws Exception {
		SerieTemporal serie =
	...
	@Test
	public void sequenciaSimplesDeCandlesAbertura() throws Exception {
		SerieTemporal serie =
				GeradorDeSerie.criaSerie(1, 2, 3, 4, 3, 4, 5, 4, 3);
...
//	@Test
//	public void sequenciaSimplesDeCandlesFechamentoComIntervalo() throws Exception {
//		SerieTemporal serie =
//				GeradorDeSerie.criaSerie(1, 2, 3, 4, 3, 4, 5, 4, 3);
//		Indicador mms = new MediaMovelSimples(new IndicadorFechamento());
//		assertEquals(2.0, mms.calculaIntervalo(2, serie, 2), 0.00001);
//		
//	}
}
